        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobApplicationFormId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Specialisations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Specialisations_JobApplicationForms_JobApplicationFormId",
                        column: x => x.JobApplicationFormId,
                        principalTable: "JobApplicationForms",
                        principalColumn: "Id");
                });
